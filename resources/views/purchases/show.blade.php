        ...
        <div class="pt-12 pb-24 bg-blueGray-100">
            <div class="container px-4 mx-auto">
                <ul class="flex flex-wrap items-center mb-10 xl:mb-0">
                    ...
                    <li><a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#">{{ __('your_order') }}</a></li>
                </ul>

                <div class="pb-9 mb-7 text-center border-b border-black border-opacity-5">
                    <h2 class="text-9xl xl:text-10xl leading-normal font-heading font-medium text-center">{{ __('your_order') }}</h2>
                </div>
                ...
                <div class="md:flex md:flex-wrap">
                    <div class="w-full md:w-7/12 xl:w-9/12 md:pr-7 mb-14 md:mb-0">
                        <div class="sm:flex sm:items-center p-8 xl:py-10 xl:px-20 mb-4 bg-white rounded-3xl">
                            ...
                            <h3 class="sm:ml-10 text-lg xl:text-xl font-heading font-medium text-center md:text-left">{{ __('payment_completed') }}</h3>
                        </div>

                        <div class="p-8 xl:py-12 xl:px-16 mb-10 xl:mb-16 bg-white rounded-3xl">
                            <p class="sm:pl-7 mb-11 text-gray-400 font-medium">{{ __('what_you_ordered') }}:</p>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex flex-wrap">
                                            <p class="mr-4 text-sm font-medium">
                                                <span class="font-heading">{{ __('type') }}:</span>
                            ...
                            @empty
                                <p class="text-red-500">{{ __('no_products_found') }}</p>
                            @endforelse
                        </div>

                        <div class="sm:w-96">
                            <a class="block py-5 px-10 w-full text-lg xl:text-xl leading-6 font-medium tracking-tighter font-heading text-center bg-white focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:bg-opacity-60 rounded-xl" href="{{ route('profile.purchaseHistory') }}">{{ __('back_to_overview') }}</a>
                        </div>
                    </div>

                    <div class="w-full md:w-5/12 xl:w-3/12 md:pl-7">
                        <h2 class="mb-7 md:mt-6 text-3xl font-heading font-medium">{{ __('details') }}</h2>
