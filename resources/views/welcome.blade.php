                                    ...
                                    <div class="bg-white border border-gray-200 rounded-3xl shadow-md overflow-hidden flex flex-col">
                                        ...
                                        <div class="px-5 py-4 flex-1 flex flex-col justify-between">
                                                ...
                                                @auth
                                                    <div class="mb-3">
                                                        @if(auth()->user()->favorites->contains($ad->id))
                                                            <form action="{{ route('ads.unfavorite', $ad) }}" method="POST" class="inline">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="text-red-500 hover:text-red-600 text-sm transition">
                                                                    ❤️ Verwijder favoriet
                                                                </button>
                                                            </form>
                                                        @else
                                                            <form action="{{ route('ads.favorite', $ad) }}" method="POST" class="inline">
                                                                @csrf
                                                                <button type="submit" class="text-gray-500 hover:text-blue-600 text-sm transition">
                                            ...
                                            <span class="text-xl font-bold text-gray-900">
                                                ...
                                                <form method="POST" action="{{ route('cart.add', $ad) }}">
                                                    @csrf
                                                    <button type="submit"
