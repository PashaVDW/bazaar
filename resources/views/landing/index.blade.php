...
<div class="max-w-5xl mx-auto mt-12">
    @if (!$landingPage)
        <div class="bg-white border-4 border-dashed border-gray-300 rounded-xl p-16 text-center shadow-sm">
            ...
            <a href="{{ route('landing.create') }}" class="bg-orange-500 text-white px-6 py-3 rounded hover:bg-orange-600">
                Create Landing Page
            </a>
        </div>
    @else
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('landing.edit') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Edit Page</a>
        </div>
