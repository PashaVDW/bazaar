...
@section('content')
    <div class="w-full max-w-2xl mx-auto px-6 py-10">
        <div class="text-center mb-6">
            <div class="mt-2">
                <h3 class="text-2xl font-semibold">Edit Advertisement</h3>
                <p class="text-sm text-gray-500">Update your advertisement below</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('advertisements.update', $ad->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                <label for="image"
                    ...
                    <span id="file-name">Change image (optional)</span>
            ...
            <p class="mt-4 text-sm text-center text-gray-500">
                <a href="{{ route('advertisements.index') }}" class="text-purple-600 hover:underline">← Back to overview</a>
            </p>
        </form>
    </div>
    ...
    <script>
        function updateFileName(input) {
            ...
            if (input.files.length > 0) {
                ...
                label.textContent = 'Change image (optional)';
            }
        }
    </script>
@endsection
