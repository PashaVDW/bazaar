...
<div class="max-w-2xl mx-auto py-10">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Upload Signed Contract for {{ $business->company_name }}</h1>

    <form action="{{ route('admin.contracts.upload.save', $business->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
                ...
                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                    <svg aria-hidden="true" class="w-10 h-10 mb-3 text-gray-400" fill="none" stroke="currentColor"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M7 16V4m0 0l-4 4m4-4l4 4m5 0v12m0 0l4-4m-4 4l-4-4" />
                    </svg>
        ...
        <div class="text-right">
            <button type="submit"
                    class="inline-block bg-primary text-white font-medium text-sm px-5 py-2.5 rounded-lg hover:bg-orange-600 transition">
                Upload Contract
            </button>
        </div>
    </form>
